    ...
    let conteudo = {
        ...
        docesbrasileiros: (
            <>
                ...
                <ul>
                    <li> <img className="doce" src={brigadeiro} alt="candy" /> Brigadeiro gourmet (tradicional, branco, etc)  <strong>R$ 3,50 (unidade)</strong></li>
        ...
        colddeserts: (
            <>
                ...
                <ul>
                    ...
                    <li><img className="doce" src={sorvete} alt="icecream" /> Sorvete artesanal  <strong>R$ 12,90 (pote 500ml)</strong></li>
                    <li><img className="doce" src={sorvete} alt="icecream" /> Geladinho gourmet  <strong>R$ 5,00 (unidade)</strong></li>
                </ul>
            </>
        ),
        chocoandbrownie: (
            <>
                ...
                <ul>
                    ...
                    <li><img className="doce" src={chocolate} alt="chocolate" /> Trufas de chocolate (tradicional, ninho, sensação, etc)  <strong>R$ 4,90 (unidade)</strong></li>
